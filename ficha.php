            ...
            <div class="card-header">
                ...
                <div class="card-tools">
                    <ul class="nav nav-pills ml-auto">
                        ...
                        <li class="nav-item"><a class="nav-link" href="#habil" onclick="Validar_Tab(0)" data-toggle="tab">Habilitación</a></li>
                        <li class="nav-item"><a class="nav-link" href="#composicion" onclick="Validar_Tab(0)" data-toggle="tab">Composición</a></li>
                        ...
                        <li class="nav-item"><a class="nav-link" href="#laboratorio" onclick="Validar_Tab(0)" data-toggle="tab">Laboratorio</a></li>
                        <li class="nav-item">
...
<script type="text/javascript">
    ...
    function Buscar_Laboratorio1(nm) {
        var param = 'ficha='+nm+'&tp=laboratorio1';
        ...
        $.ajax({
            ...
            success: function(data){
                if(data != 0){
                    $('#dv_tbl_lab1').html(data);
                    // $('#dv_btn_comp1').css("display:show;")
                }/*else{
                    $('#dv_tbl_otro').empty();
                }*/
            },
