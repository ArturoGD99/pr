            ...
            if($r1->RecordCount()>0){
                ...
                while(!$r1->EOF){
                    ...
                    if($r1->fields['INDICACION4']!= '')
                        echo "<tr style='text-align: justify'><td width='20%' align='justify' style='text-align: justify;'>".$r1->fields['INDICACION4']."</td></tr>";//cuidado
                    if($r1->fields['INDICACION']!= '')
                        echo "<tr style='text-align: justify'><td width='20%' align='justify' style='text-align: justify;'>".$r1->fields['INDICACION']."</td></tr>";//grls
                    if($r1->fields['INDICACION3']!= '')
    ...
    <div style="width: 65%; height: 400px; border: solid 0px blue; display: inline-block;">-->
            ...
            if($rm->RecordCount()>0){
                ...
                while(!$rm->EOF){
                    ...
                    if($rv->RecordCount()>0){
                        while(!$rv->EOF){
                            echo "<td style='align-content: center; text-align: center; border: 1px solid black; width: auto'>".$rv->fields['ICOD']."<br>".$rv->fields['COLOR']."<br><label style='font-size: 8px'>".str_replace('@','<br>',$rv->fields['PRV_FACT'])."</label></td>";
                            $rv->MoveNext();
                        }
                    }
                    echo "</tr>";
